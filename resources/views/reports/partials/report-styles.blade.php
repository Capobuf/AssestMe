...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .priority-legend--compact td { padding-bottom: 1.5mm; padding-top: 1.5mm; }
    .priority-legend--compact .priority-legend__bar { height: 5mm; }
    ...
    .findings-summary-section .section-heading { margin-bottom: 4mm; padding-bottom: 2mm; }
    .findings-summary__description { color: #666666; margin: 0 0 4mm 20mm; }
    ...
    .finding-summary__details td { border-top: 0.25mm solid #D7D7D2; color: #333333; padding-bottom: 1.25mm; }
    ...
    .finding-indicators { margin: 3mm 0 0; }
    .finding-indicator {
    ...
    .management-note { background: #F3F3EF; border-left: 1.3mm solid #111111; margin: 2.5mm 0 3mm; padding: 2.5mm; }
    .management-note__label { font-size: 7.25pt; font-weight: bold; letter-spacing: 0.09em; margin-bottom: 1.5mm; text-transform: uppercase; }
    .management-note .pre-line { font-size: 9.25pt; line-height: 1.32; }
    ...
    .recommended-solution { border-top: 0.7mm solid {{ $report->setting('primary_color') }}; padding-top: 2.5mm; }
    ...
    .solution-metrics { background: #F3F3EF; margin-top: 3mm; table-layout: fixed; }
    .solution-metrics td { border-left: 0.25mm solid #D7D7D2; padding: 2mm 2.5mm; }
    ...
    .classification-table td { border-top: 0.25mm solid #D7D7D2; padding: 1.2mm 0; text-align: left; }
    ...
    .asset-details { border-top: 0.3mm solid #111111; margin-bottom: 2mm; }
    .asset-details th,
    .asset-details td { border-bottom: 0.25mm solid #D7D7D2; padding: 1mm 0; text-align: left; }
