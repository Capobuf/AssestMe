...
<style>
    ...
    .assestme-report-preview__section-number { display: table-cell; font-size: 2.1rem; font-weight: 800; line-height: 1; width: 2.6rem; }
    .assestme-report-preview__section-title { display: table-cell; font-size: 1rem; font-weight: 800; padding-top: 0.25rem; }
    ...
    .assestme-report-preview__kpis { border-bottom: 1px solid #D7D7D2; border-top: 1px solid #D7D7D2; display: table; margin-top: 0.8rem; width: 100%; }
    ...
    .assestme-report-preview__finding { border-bottom: 1px solid #111111; border-top: 1px solid #111111; display: table; margin-top: 0.9rem; width: 100%; }
    .assestme-report-preview__finding-number { display: table-cell; font-size: 1.1rem; font-weight: 800; padding: 0.45rem; width: 2rem; }
    .assestme-report-preview__finding-copy { border-left: 1px solid #D7D7D2; display: table-cell; font-size: 0.58rem; padding: 0.45rem; }
    ...
    .assestme-report-preview__metrics { display: table; font-size: 0.55rem; width: 100%; }
    .assestme-report-preview__metrics span { border-top: 1px solid #D7D7D2; display: table-cell; padding-top: 0.4rem; }
...
>
    ...
    <div class="assestme-report-preview__sheet" data-dusk="report-preview-internal">
        ...
        <div class="assestme-report-preview__section">
            <div class="assestme-report-preview__section-number">01</div>
            <div class="assestme-report-preview__section-title">{{ __('assestme.settings.preview.overview') }}</div>
        </div>
        <div class="assestme-report-preview__kpis">
            <div class="assestme-report-preview__kpi"><strong>03</strong><span>{{ __('assestme.settings.preview.total_findings') }}</span></div>
            <div class="assestme-report-preview__kpi"><strong>01</strong><span>{{ __('assestme.settings.preview.high_priority') }}</span></div>
        </div>
        ...
        @if ($get('summary_table') === true)
            <div class="assestme-report-preview__finding">
                ...
                <div class="assestme-report-preview__finding-copy">
                    ...
                    {{ __('assestme.settings.preview.priority') }} / {{ __('assestme.settings.preview.status') }}
                </div>
            </div>
        @endif
