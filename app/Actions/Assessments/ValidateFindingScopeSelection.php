...
{
    /** @return list<string> */
    public function messages(ScopeType $scope, int $siteCount, int $assetCount, ?string $description): array
    {
        $messages = [];
        ...
        if ($scope === ScopeType::SelectedAssets && $assetCount === 0) {
    ...
    public function __invoke(ScopeType $scope, int $siteCount, int $assetCount, ?string $description): void
    {
        $messages = $this->messages($scope, $siteCount, $assetCount, $description);
