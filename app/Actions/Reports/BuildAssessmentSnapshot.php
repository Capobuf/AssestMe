...
final class BuildAssessmentSnapshot
{
    ...
    private function settingsSnapshot(): array
    {
        return [
            ...
            'pdf_image_dpi' => $this->reportSettings->pdf_image_dpi,
            'pdf_jpeg_quality' => $this->reportSettings->pdf_jpeg_quality,
            'pdf_optimize_images' => $this->reportSettings->pdf_optimize_images,
